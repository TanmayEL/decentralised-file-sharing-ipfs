...
4. **Configure environment variables**
   ...
   - Set JWT secret and MongoDB URI (local or Atlas)
...
- **MongoDB**: Database for metadata (local or Atlas)
...
5. **Metadata Storage**: File information stored in MongoDB (local or Atlas)
